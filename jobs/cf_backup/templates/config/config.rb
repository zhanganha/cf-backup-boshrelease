...
Utilities.configure do
  pg_dump '/var/vcap/packages/postgresql_client/bin/pg_dump'
end
...
Logger.configure do
  ...
  logfile.log_path  = '/var/vcap/sys/log/cf_backup'
...
Storage::Local.defaults do |local|
  local.path = "/var/vcap/store/backups"
  local.keep = <%= p('cf_backup.keep').to_i %>
end
